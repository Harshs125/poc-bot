...
urlpatterns = [
    ...
    path('organizations/<int:id>',views.OrganizationAPI.as_view(),name='add_organization'),
    path('configurations',views.ConfigurationAPI.as_view(),name='configurations'),
    path('configurations/<int:id>',views.ConfigurationAPI.as_view(),name='configurations_update'),
